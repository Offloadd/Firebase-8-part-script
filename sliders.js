...
const labelInput = document.getElementById(‘label_’ + category + ‘*’ + key);
const posInput = document.getElementById(’pos*’ + category + ‘*’ + key);
const negInput = document.getElementById(’neg*’ + category + ‘_’ + key);
